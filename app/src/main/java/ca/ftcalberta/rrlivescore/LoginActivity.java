...
import ca.ftcalberta.rrlivescore.utils.auth.Authenticator;
import ca.ftcalberta.rrlivescore.utils.auth.GoogleAuthenticator;
import ca.ftcalberta.rrlivescore.utils.testing.SimpleIdlingResource;
...
public class LoginActivity extends Activity implements
    ...
    /**
     * Once the user is authenticated go to the scoring activity
     * @see ScoringActivity
     */
    @Override
    public void onAuthSuccess() {
        ...
        Intent transition = new Intent(LoginActivity.this, ScoringActivity.class);
