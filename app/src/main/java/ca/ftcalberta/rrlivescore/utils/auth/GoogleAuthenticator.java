...
package ca.ftcalberta.rrlivescore.utils.auth;
...
import ca.ftcalberta.rrlivescore.R;

/**
 * Handles Firebase authentication via Google OAuth 2.0
 */
public class GoogleAuthenticator extends Authenticator {
    ...
    /**
     * Initiate Google sign in request
     */
    @Override
    public void signIn() {
